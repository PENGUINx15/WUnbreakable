package me.penguin.wunbreakable.API;

import me.clip.placeholderapi.PlaceholderAPI;
import me.penguin.wunbreakable.WUnbreakable;
...
public class MessageManager implements Listener {
	...
	private final WUnbreakable plugin;
    public MessageManager(WUnbreakable plugin) {
    	this.plugin = plugin;
	}
